...
public class MenuItem_1 extends javax.swing.JPanel {
    ...
    public EventMenuSelected_1 getEventSelected() {
        return eventSelected;
    }

    public void setEventSelected(EventMenuSelected_1 eventSelected) {
    ...
    private EventMenuSelected_1 eventSelected;
    private int index;

    public MenuItem_1(ModelMenu menu, EventMenu event, EventMenuSelected_1 eventSelected, int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = eventSelected;
        this.index = index;
        ...
        firstItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (menu.getSubMenu().length > 0) {
                    if (event.menuPressed(MenuItem_1.this, !open)) {
                        open = !open;
                    }
                }
