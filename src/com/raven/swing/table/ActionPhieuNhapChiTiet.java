...
public class ActionPhieuNhapChiTiet extends javax.swing.JPanel {

    public ActionPhieuNhapChiTiet(ModelActionPhieuNhapChiTiet data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEventPhieuNhapChiTiet().update(data.getPnct());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEventPhieuNhapChiTiet().delete(data.getPnct());
            }
        });
    }
